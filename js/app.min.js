import { E as EgwApp, b as etemplate2, ac as SlMenuItem, a7 as et2_dialog, g as et2_nextmatch } from '../../chunks/etemplate2-dd557998.js';
...
class SchulmanagerApp extends EgwApp {
  ...
  et2_ready(et2, name) {
    ...
    if (name == 'schulmanager.notenmanager.edit') {//this.header_change();
    }
  ...
  changeNote(action, _senders) {
    let tokenDiv = document.getElementById('schulmanager-notenmanager-edit_token'); //let inputinfo_date = <HTMLInputElement> document.getElementById('schulmanager-notenmanager-edit_date').firstChild;
  ...
  changeGewAllModified(_action, _senders) {
    let et2 = this.et2;
    let func = 'schulmanager.schulmanager_ui.ajax_gewAllModified'; //let noteKey = _action.name;

    let noteKey = _senders._widget_id;
    let noteVal = _action.value; //if(_action.type == "checkbox"){
  ...
  schuelerViewUpdate(instance, result) {
    ...
    instance.tableUpdate("schulmanager-schuelerview_grid-san", result['san_nm_rows']); //instance.tableUpdate("schulmanager-schuelerview_not_nm[rows]", result['noten_nm_rows']);
    // ################
