...
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'K',   '10')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Ev',  '11')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Eth', '12')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'D',   '20')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'L',   '30')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Gr',  '31')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'E',   '32')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'F',   '33')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Sp',  '34')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'M',   '40')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Inf', '41')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Ph',  '42')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Ch',  '43')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'B',   '44')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'NuT', '45')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'G',   '50')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Geo', '51')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'WR',  '52')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Sk',  '53')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Ku',  '54')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Mu',  '60')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Sm',  '70')");
$oProc->query("INSERT INTO {$egw_config} (cnf_key, cnf_val, cnf_extra) VALUES ('#FACH_ORDER#', 'Sw',  '71')");