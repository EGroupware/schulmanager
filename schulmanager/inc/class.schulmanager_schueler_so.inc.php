...
class schulmanager_schueler_so {
	...
	/*
	 select
			...
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'glnw_hj_1' AND egw_schulmanager_note.note_index_im_block < 0 THEN egw_schulmanager_note.note_note END) AS glnw_hj_1_avg,
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'glnw_hj_1' AND egw_schulmanager_note.note_asv_note_manuell = '1' THEN '1' END) AS glnw_hj_1_avg_manuell,
		   ...
		   GROUP_CONCAT(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'klnw_hj_1' AND egw_schulmanager_note.note_index_im_block >= 0 THEN egw_schulmanager_note.note_note END ORDER BY egw_schulmanager_note.note_index_im_block SEPARATOR ' | ') AS klnw_hj_1,
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'klnw_hj_1' AND egw_schulmanager_note.note_index_im_block < 0 THEN egw_schulmanager_note.note_note END) AS klnw_hj_1_avg,
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'klnw_hj_1' AND egw_schulmanager_note.note_asv_note_manuell = '1' THEN '1' END) AS klnw_hj_1_avg_manuell,
			...
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'glnw_hj_2' THEN egw_schulmanager_note.note_note END) AS glnw_hj_2_avg,
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'glnw_hj_2' AND egw_schulmanager_note.note_asv_note_manuell = '1' THEN '1' END) AS glnw_hj_2_avg_manuell,
			...
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'klnw_hj_2' THEN egw_schulmanager_note.note_note END) AS klnw_hj_2_avg,
			MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'klnw_hj_2' AND egw_schulmanager_note.note_asv_note_manuell = '1' THEN '1' END) AS klnw_hj_2_avg_manuell,
			...
			-- AND egw_schulmanager_note.note_index_im_block = '-1'

			WHERE egw_schulmanager_asv_schueler_schuljahr.ss_asv_id= '001e6779/d490/161d16bb/ade/b4f'

			 GROUP BY egw_schulmanager_asv_schuelerfach.sf_asv_id, egw_schulmanager_asv_schuelerfach.sf_asv_kurzform, egw_schulmanager_asv_schuelerfach.sf_asv_anzeigeform

			ORDER BY egw_schulmanager_asv_schuelerfach.sf_asv_anzeigeform
	 */

	function &getNotenAbstract($schueler_schuljahr_id, &$rows, $rowid){

		// sample schueler_schuljahr_id : aj22/fhqa/anbv/r714/m5yk
		// egw_schulmanager_asv_schueler_schuljahr.ss_asv_id= '001e6779/d490/161d16bb/ade/b4f'
		$sql = "select
			egw_schulmanager_asv_schuelerfach.sf_asv_id AS asv_id,
			egw_schulmanager_asv_schuelerfach.sf_asv_kurzform AS asv_kurzform,
			egw_schulmanager_asv_schuelerfach.sf_asv_anzeigeform AS asv_anzeigeform,
	 ...
	 * select
			...
			WHERE egw_schulmanager_note.note_index_im_block = -1  AND egw_schulmanager_note.note_asv_schueler_schuljahr_id= '001e6779/d490/161d16bb/ade/d97'
	 */
	/**
	...
	function formatDecimal($noteDec, $dec = 2){
		...
		//return number_format(floatval($noteDec), 2, ',');
	}
		...
		if(isset($schueler['noten'])){
			...
			/*if(empty($schueler['noten']['note_hj_1'][-1]['note']) || $schueler['noten']['note_hj_1'][-1]['manuell'] == 0){
				if($schueler['noten']['schnitt_hj_1'][-1]['value'] > 0){
					$schueler['noten']['note_hj_1'][-1]['note'] = round($schueler['noten']['schnitt_hj_1'][-1]['value'] - 0.01, 0, PHP_ROUND_HALF_UP);
				}
				else{
...
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'alt_b' THEN egw_schulmanager_note.note_note END) AS alt_b,
-- 1. HJ
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'glnw_hj_1' THEN egw_schulmanager_note.note_note END) AS glnw_hj_1,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'klnw_hj_1' THEN egw_schulmanager_note.note_note END) AS klnw_hj_1,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'schnitt_hj_1' THEN egw_schulmanager_note.note_note END) AS schnitt_hj_1,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'note_hj_1' THEN egw_schulmanager_note.note_note END) AS note_hj_1,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'm_hj_1' THEN egw_schulmanager_note.note_note END) AS m_hj_1,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'v_hj_1' THEN egw_schulmanager_note.note_note END) AS v_hj_1,
-- 2. HJ
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'glnw_hj_2' THEN egw_schulmanager_note.note_note END) AS glnw_hj_2,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'klnw_hj_2' THEN egw_schulmanager_note.note_note END) AS klnw_hj_2,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'schnitt_hj_2' THEN egw_schulmanager_note.note_note END) AS schnitt_hj_2,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'note_hj_2' THEN egw_schulmanager_note.note_note END) AS note_hj_2,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'm_hj_2' THEN egw_schulmanager_note.note_note END) AS m_hj_2,
MAX(CASE WHEN egw_schulmanager_note.note_blockbezeichner = 'v_hj_2' THEN egw_schulmanager_note.note_note END) AS v_hj_2
...
LEFT JOIN egw_schulmanager_note ON egw_schulmanager_note.note_asv_schueler_schuljahr_id = egw_schulmanager_asv_schueler_schuljahr.ss_asv_id AND egw_schulmanager_note.note_asv_schueler_schuelerfach_id = egw_schulmanager_asv_schuelerfach.sf_asv_id AND egw_schulmanager_note.note_index_im_block = '-1'

WHERE egw_schulmanager_asv_schueler_schuljahr.ss_asv_schueler_stamm_id= 'aj22/fhqa/anbv/r714/m5yk'
